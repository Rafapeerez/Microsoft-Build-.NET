...
**(30) -->** This module is about on reviewing application configuration in microservices. The module covers configuration providers, hierarchical configuration, environment-specific configuration, and secure configuration handling. Also priorize the importance of a flexible and scalable configuration approach for microservices architectures.
**(31) -->** The 33rd module explores the use of managed data stores such as Azure SQL Database and Azure Cosmos DB in microservices architectures. The module covers key concepts like data partitioning, consistency models, and scaling strategies for managing data in distributed systems. It emphasizes the benefits and considerations of using managed data stores for microservices applications.
**(32) -->** This module focuses on reviewing the concept of API gateways and the benefits of using the BFF pattern. The module covers topics like request aggregation, response composition, security, and caching in API gateways. It emphasizes the role of API gateways in simplifying client communication and enhancing the performance and security of microservices architectures.
**(33) -->** In the last module I haven´t learned a lot because it hasn´t got theorical part. The module is about how stored sensitive information used by the GitHub Actions and implement a GitHub Action to build the coupon service's container image in ACR.  
Honestly, I have not been able to enjoy these last modules as I had planned and well, I have learned just enough that I have been able to read and obviously without the practical part it has cost me more. 
To end the course, I would like to give my opinion, it is quite complete but it is noticeable that it is made very modular and there are certain messy aspects, some modules explained in one way and others in another, but in general I have learned a lot and it has been entertaining.
